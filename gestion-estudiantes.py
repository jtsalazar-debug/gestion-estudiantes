...
def mostrar_menu():
    ...
    print("2. Opción 2 (No especificada)")
    print("3. Opción 3 (No especificada)")
...
while programa_activo == True:
    ...
    if opcion == 1:
        ...
        print()
        print("Funcionalidad de la Opción 2 no descrita en el documento.")
        
    elif opcion == 3:
        print()
        print("Funcionalidad de la Opción 3 no descrita en el documento.")
